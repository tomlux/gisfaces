...
*
* Note: The proxy configuration file location has been modified for GISFaces.
----------------------------------------------------------- -->
...
<%!
    ...
    public static class ProxyConfig
    {
        public boolean canReadProxyConfig(){
            InputStream configFile = ProxyConfig.class.getClassLoader().getResourceAsStream("com/gisfaces/proxy/proxy.xml");
