...
public class ComponentUtilities
{
	 ...
	 * @param id Faces Client ID.
	 * @return <code>true</code> if client ID is qualified, <code>false</code> otherwise.
	 */
	...
	public static final String qualifyClientId(String parent, String child)
	{
		...
		if ((parent != null) && (child != null))
		{
			...
			{
				// Remove the leading faces separator in order to match the generated HTML element ID.
				id = id.substring(1);
			}
		}
	...
	public static final String getClientBehaviorAjaxScript(UIComponent component, String event)
	{
		...
		ClientBehaviorContext behaviorContext = ClientBehaviorContext.createClientBehaviorContext(FacesContext.getCurrentInstance(), component, event, component.getClientId(), null);
	...
	/**
	 * Method to remove extraneous script parameter value quotes.
	 * This is necessary because <code>ClientBehavior.getScript()</code> always puts single quotes around the parameter value.
	 * The <code>ClientBehaviorContext.Parameter</code> class needs an indicator for this.
	 * @param script JavaScript generated from a <code>ClientBehavior.getScript()</code> invocation.
	 ...
	 * @return <code>true</code> if the component has an <code>action</code> or <code>actionListener</code> attribute specified, <code>false</code> otherwise.
	 */
	 ...
	 * @return <code>true</code> if the specified component client ID initiated the request, <code>false</code> otherwise.
	 */
	 ...
	 * @return <code>true</code> if the component attribute is a value expression, <code>false</code> otherwise.
	 */
	...
	/**
	 * Method to get the specified resource from the resources directory.
	 * The <code>getContentType</code> and <code>getRequestPath</code> methods are particularly useful when building <code>link</code> and <code>script</code> tags dynamically.
	 * @param fc FacesContext
