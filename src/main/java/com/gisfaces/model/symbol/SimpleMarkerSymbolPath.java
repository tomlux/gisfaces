 ...
 * @see <a href="https://developers.arcgis.com/javascript/latest/api-reference/esri-symbols-SimpleMarkerSymbol.html#path">ESRI Symbol</a>
 */
public enum SimpleMarkerSymbolPath
{
	...
	CROSS		("M 415,214 415,230 M 407,222 423,222"),
	DIAMOND		("M 415,214 423,222 415,230 407,222 Z"),
	...
	POLYGON		("M -10,-10 L 10,0 L 10,10 L -10,10 L -10,-10 Z"),
	SQUARE		("M 407,214 423,214 423,230 407,230 Z"),
